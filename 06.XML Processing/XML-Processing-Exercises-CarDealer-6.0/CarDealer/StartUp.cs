...
namespace CarDealer
{
    public class StartUp
    {
        ...
        public static string ImportParts(CarDealerContext context, string inputXml)
        {
            ...
            ImportPartsDto[] partsImportDtos;
            using (StringReader inReader = new StringReader(inputXml))
            {
                partsImportDtos = (ImportPartsDto[])xmlSerializer.Deserialize(inReader);
            }
        ...
        public static string ImportCars(CarDealerContext context, string inputXml)
        {
            ...
            ImportCarsDto[] carImportDtos;
            using (StringReader reader = new StringReader(inputXml))
            {
                carImportDtos = (ImportCarsDto[])xmlSerializer.Deserialize(reader);
            };
